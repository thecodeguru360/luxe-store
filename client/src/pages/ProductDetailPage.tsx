          ...
          {product.product_rating && (
            <div className="flex items-center space-x-4">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm text-gray-600">{product.product_rating}</span>
              </div>
              <span className="text-sm text-gray-500">|</span>
              <span className="text-sm text-blue-600 hover:underline cursor-pointer">128 reviews</span>
            </div>
          )}
                ...
                <div className="grid grid-cols-6 gap-2">
                  {sizes.map((size) => (
                    <Button
                      ...
                      className={`py-2 ${selectedSize === size ? 'bg-blue-600 text-white' : ''}`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <div className="flex items-center space-x-4 mb-4">
                  <span className="text-4xl font-bold">{product.product_rating}</span>
                  <div>
                    <div className="flex mb-1">
                      {product.product_rating && renderStars(parseFloat(product.product_rating))}
                    </div>
          ...
          {[
            {
              ...
              rating: 5,
              date: '2 days ago',
              review: 'Excellent quality! Very comfortable and stylish. The fit is perfect and they look great with both casual and semi-formal outfits.',
              size: '9',
              color: 'White'
            },
            {
              ...
              rating: 5,
              date: '1 week ago',
              review: 'Love these! Great value for money and very comfortable for daily wear. Shipped quickly and arrived in perfect condition.',
              size: '7',
              color: 'White'
            }
          ].map((review, index) => (
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-500">
                      <span>Size: {review.size}</span> | <span>Color: {review.color}</span>
                    </div>
                  </div>
                </div>
              </CardContent>
