import { Search, ShoppingBag, Palette, Shirt, Sparkles, TrendingUp } from 'lucide-react';
...
export function HomePage() {
  ...
  const searchSuggestions = [
    { text: "Show me trending sneakers under $200", icon: TrendingUp, category: "Popular" },
    { text: "Find luxury handbags for evening events", icon: Sparkles, category: "Luxury" },
    { text: "Comfortable running shoes for daily workouts", icon: ShoppingBag, category: "Sports" },
    { text: "Natural makeup products for sensitive skin", icon: Palette, category: "Beauty" },
    { text: "Vintage denim jackets in size medium", icon: Shirt, category: "Fashion" },
    { text: "Professional accessories for office wear", icon: ShoppingBag, category: "Work" },
  ];
      ...
      <section className="hero-gradient text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center mb-4">
            ...
            <Badge variant="secondary" className="bg-blue-500/20 text-blue-100 border-blue-300/30 ai-badge-float">
              AI-Powered Search
            </Badge>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Find Your Perfect Style</h1>
          <p className="text-xl mb-8 text-gray-300">Ask our AI to find exactly what you're looking for</p>
          ...
          <div className="max-w-4xl mx-auto mb-12">
            ...
            <div className="text-left">
              <p className="text-sm text-blue-200 mb-4 text-center">Try these AI-powered searches:</p>
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <Badge variant="secondary" className="bg-white/20 text-white text-xs mb-2 border-0">
                            {suggestion.category}
                          </Badge>
